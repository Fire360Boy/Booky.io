        ...
        <div class="container" >
            <div class="row" >
                <div class="col-lg-8 col-lg-offset-2 text-center" >
                    ...
                    <img src="img/devices.png" class="img-responsive col-xs-6 col-xs-offset-3" >
        ...
        <div class="container-fluid" >
            <div class="row no-gutter popup-gallery" >
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/portfolio/fullsize/1.jpg')); ?>" class="portfolio-box" >
                        <img src="<?php echo e(asset('img/portfolio/thumbnails/1.jpg')); ?>" class="img-responsive" alt="" >
                ...
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/screen-default.gif')); ?>" class="portfolio-box" >

                        <img src="<?php echo e(asset('img/Screen_Default.gif')); ?>" class="img-responsive " alt="" >
                ...
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/portfolio/fullsize/3.jpg')); ?>" class="portfolio-box" >
                        <img src="<?php echo e(asset('img/portfolio/thumbnails/3.jpg')); ?>" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption" >
                            <div class="portfolio-box-caption-content" >
                                <div class="project-category text-faded" >
                                    Test Title
                ...
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/portfolio/fullsize/4.jpg')); ?>" class="portfolio-box" >
                ...
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/portfolio/fullsize/5.jpg')); ?>" class="portfolio-box" >
                ...
                <div class="col-lg-4 col-sm-6" >
                    <a href="<?php echo e(asset('img/portfolio/fullsize/6.jpg')); ?>" class="portfolio-box" >
